                    ...
                    <span>Course Status</span>
                                    ...
                                    <div>
                                        <div className="mt-3">     
                                            ...
                                            <div className="mt-2">
                                                <Link to="#" style={{color:"crimson", textDecoration: "none"}}><Bs1CircleFill style={{color:"crimson"}}/>  Grade A1 - ENV + HTML</Link>
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <div className="mt-2">
                                                ...
                                                <div className="ms-4" style={{fontSize:"12px"}}>
                                                    <label style={{color:"grey"}}>Lecture CS4550.12631.202410</label>
                                                    <label style={{color:"grey"}}>Sep 7 at 11:45am</label>
                                                </div>
                                                
                                            </div>
                                            <div className="mt-3">
                                                <Link to="#" style={{color:"crimson", textDecoration: "none"}}><IoCalendarNumberOutline style={{color:"grey"}}/> CS5610 06 SP23 Lecture</Link>
                                                <div className="ms-4" style={{fontSize:"12px"}}>
                                                    <label style={{color:"grey"}}>Lecture CS4550.12631.202410</label>
                                                    ...
                                                    <div className="col-auto">
                                                            ...
                                                            <div className="d-flex">
                                                                ...
                                                                <div className="ms-1 mt-1">      
                                                                    <span style={{color:"crimson"}}>CS5610 Web Development Summer 1 2023 - LECTURE</span>
                                                                </div>    
                                                            </div>
